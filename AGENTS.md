...
- про деплой и сборку образов читай в `docs/deploy.md` и конфигурацию `services.yaml` (он используется `codexctl` и GitHub‑раннерами для dev/ai/ai-staging‑окружений).
