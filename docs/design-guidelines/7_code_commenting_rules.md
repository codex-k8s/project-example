...
- у экспортируемых пакетов есть package comment;
- у экспортируемых типов/функций/методов есть комментарии;
- сложная логика и компромиссы объяснены;
- комментарии объясняют *зачем*, а не *что*;
- нет устаревших/вводящих в заблуждение комментариев.
