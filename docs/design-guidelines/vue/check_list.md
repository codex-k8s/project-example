...
- Если менялись контракты (OpenAPI/AsyncAPI): сгенерированные файлы в `**/generated/**` обновлены и не правились руками (см. `docs/design-guidelines/go/code_generation.md`).
