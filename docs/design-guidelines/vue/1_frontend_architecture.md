# 1 — Frontend: архитектура и размещение
...
- Контракт UI с backend: HTTP/OpenAPI (`api/server/api.yaml`) и стабильный формат ошибок (см. `docs/design-guidelines/go/6_error_handling.md`).
